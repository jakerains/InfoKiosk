  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white p-6 flex flex-col relative overflow-hidden">
      ...
      <header className="mb-12 relative z-10">
        <h1 className="text-[5.5rem] font-bold text-transparent bg-clip-text animate-gradient bg-[size:200%] bg-[linear-gradient(90deg,#4285f4_0%,#9c5fff_30%,#e94a87_60%,#22c55e_100%)] tracking-wider">
          {config.headerTitle}
        </h1>
